...
} io_config[] = 
{
    ...
    IOCONFIG(BSP_I2C0_CLK_PIN,FUNC_I2C0_SCLK),
    IOCONFIG(BSP_I2C0_SDA_PIN,FUNC_I2C0_SDA),
#endif
#ifdef BSP_USING_I2C1
    IOCONFIG(BSP_I2C1_CLK_PIN,FUNC_I2C1_SCLK),
    IOCONFIG(BSP_I2C1_SDA_PIN,FUNC_I2C1_SDA),
#endif
#ifdef BSP_USING_I2C2
    IOCONFIG(BSP_I2C2_CLK_PIN,FUNC_I2C2_SCLK),
    ...
    IOCONFIG(EPAPER_CS_PIN, FUNC_SPI1_SS0),
#endif
#ifdef EPAPER_USE_SS1
    IOCONFIG(EPAPER_CS_PIN, FUNC_SPI1_SS1),
#endif
#ifdef EPAPER_USE_SS2
    IOCONFIG(EPAPER_CS_PIN, FUNC_SPI1_SS2),
#endif
#ifdef EPAPER_USE_SS3
    IOCONFIG(EPAPER_CS_PIN, FUNC_SPI1_SS3),
#endif
    IOCONFIG(EPAPER_DC_PIN, HS_GPIO(EPAPER_DC_GPIO)),
    IOCONFIG(EPAPER_RST_PIN, HS_GPIO(EPAPER_RST_GPIO)),
    IOCONFIG(EPAPER_BUSY_PIN, HS_GPIO(EPAPER_BUSY_GPIO)),
